...
var MemberAvatarComponent = function MemberAvatarComponent(_ref) {
  var onClick = _ref.onClick,
      ...
      name = _ref.name,
      title = _ref.title,
      teamLogo = _ref.teamLogo,
      etc = _objectWithoutProperties(_ref, ['onClick', 'image', 'name', 'title', 'teamLogo']);
  ...
  return _react2.default.createElement(
    ...
    name && name.length !== 0 && _react2.default.createElement(
      MemberName,
      null,
      teamLogo && teamLogo.length !== 0 && _react2.default.createElement('img', { src: teamLogo }),
      name
    ),
...
MemberAvatarComponent.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  teamLogo: _propTypes2.default.string,
