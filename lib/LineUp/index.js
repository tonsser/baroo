...
var generateLineup = function generateLineup() {
  ...
  var lineup = _lodash2.default.clone(formation);
  ...
  playersSorted.forEach(function (player) {
    if (player.primary_position) {
      ...
      var primary_position = player.primary_position;

      lineup.forEach(function (line, lineIndex) {
        line.forEach(function (position, positionIndex) {
          if (_lodash2.default.isArray(position) && position.includes(primary_position) && position.indexOf(primary_position) < bestIndex) {
...
var Lineup = function Lineup(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        _FlexboxGrid.Div,
        { row: true, aroundXs: true, className: 'baroo attackers' },
      ...
      _react2.default.createElement(
        _FlexboxGrid.Div,
        { row: true, aroundXs: true, className: 'baroo midfielders' },
      ...
      _react2.default.createElement(
        _FlexboxGrid.Div,
        { row: true, aroundXs: true, className: 'baroo defenders' },
      ...
      _react2.default.createElement(
        _FlexboxGrid.Div,
        { row: true, aroundXs: true, className: 'baroo goalkeeper' },
