...
var getPlayer = function getPlayer() {
  ...
  return _react2.default.createElement(_MemberAvatar2.default, { className: 'baroo player', image: player.profile_picture, name: player.lastname, onClick: function onClick() {
