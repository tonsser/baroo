...
var getPlayer = function getPlayer() {
  ...
  return _react2.default.createElement(_MemberAvatar2.default, { className: 'baroo player', image: player.profile_picture, name: player.lastname, teamLogo: player.teamLogo, onClick: function onClick() {
      return _onClick(player);
    } });
};
...
var Lineup = function Lineup(_ref) {
  var players = _ref.players,
      ...
      subsitutesTitle = _ref.subsitutesTitle;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      subsitutes.length !== 0 && subsitutesTitle && _react2.default.createElement(
        _FlexboxGrid.Div,
        { colXs: 12, className: 'subsitutes-title' },
        subsitutesTitle
      ),
...
Lineup.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  subsitutesTitle: _propTypes2.default.string
} : {};
