...
var Logo = _styledComponents2.default.img(_templateObject3, _Media2.default.sm(_templateObject4));
var Link = _FlexboxGrid.Div.withComponent('a').extend(_templateObject5);

var Separator = _FlexboxGrid.Div.extend(_templateObject6);
